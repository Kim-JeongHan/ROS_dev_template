...
--volume="${HERE}/.catkin/build:${HOME}/${WORKDIR}/build" \
--volume="${HERE}/.catkin/devel:${HOME}/${WORKDIR}/devel" \
--volume="${HERE}/.catkin/install:${HOME}/${WORKDIR}/install" \
--volume="${HERE}/${REPO}:${HOME}/${WORKDIR}/src/${REPO}" \
--user=$(id -u):$(id -g) \
"
DOCKER_ENV_VARS="
--env="DISPLAY" \
